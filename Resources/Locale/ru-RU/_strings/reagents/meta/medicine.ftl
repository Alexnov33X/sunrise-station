...
reagent-desc-h-32 = Продвинутый радиоактивный раствор для регенерации тела в холодных условиях. Замедляет разложение, но вызывает радиационные и клеточные повреждения. Работает как на мёртвых, так и на живых.
...
reagent-desc-doxarubixadone = Химикат криогенного действия. Лечит клеточные повреждения, вызванные опасными газами и химикатами. Работает только на живых.
